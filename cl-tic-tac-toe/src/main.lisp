(uiop:define-package cl-tic-tac-toe
  (:use #:cl))
(in-package #:cl-tic-tac-toe)
...
(defun update-board (board coords player)
  (setf
   (aref board (getf coords :x) (getf coords :y)) player))
...
(defun game (&key (board (make-array '(3 3) :initial-element '-)))
  ...
  ; (update-board board '(:x 0 :y 2) "x")
  ; (update-board board '(:x 1 :y 1) "x")
  ; (update-board board '(:x 2 :y 0) "o")
  ; (update-board board '(:x 0 :y 0) "x")
  ; (update-board board '(:x 1 :y 0) "x")
  ; (update-board board '(:x 1 :y 2) "o")
  ; (update-board board '(:x 0 :y 1) "o")
  ; (update-board board '(:x 2 :y 1) "x")
  ; (update-board board '(:x 2 :y 2) "o")
